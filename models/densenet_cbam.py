...
# ========================= M2: + CBAM (final only) =========================
class DenseNet_CBAMFinal(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, base_channels=64):
        super().__init__()
        # Init conv with CDANBlock
        ...
        # One CBAM before final conv
        self.cbam_final = CBAM(base_channels + 32*8)
...
if __name__ == "__main__":
    ...
    model = DenseNet_CBAMFinal().to(device)
