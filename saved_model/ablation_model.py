...
from models.densenet_cbam import DenseNetCBAM
from models.cdan_densenet import CDANDenseNet
...
model_variants = {
    "DenseNet": DenseNet(),
    "DenseNet_CBAM": DenseNetCBAM(),
    "CDAN_DenseNet": CDANDenseNet(),
    "CDAN_CBAM_DenseNet": CDAN_CBAM_DenseNet()
}
...
df.to_csv("ablation_results_cdan_cbam.csv", index=False)
print("\n✅ Ablation Study Results Saved to 'ablation_results_cdan_cbam.csv'")
print(df)
